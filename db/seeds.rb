...
t1 = Teacher.create(name: 'Jan', lastname: 'Kowalski', email: 'jan.kowalski@serwer.pl', phone: '123789654')
t2 = Teacher.create(name: 'Tadeusz', lastname: 'Zapolski', email: 'tadeusz.zapolskki@serwer.pl', phone: '123123123')
